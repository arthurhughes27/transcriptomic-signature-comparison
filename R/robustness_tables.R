...
# matching the convention in analysis/supplementary/is2_descriptive_supplementary.R)
...
#' analysis/supplementary/is2_descriptive_supplementary.R: `knitr::kable()` with
